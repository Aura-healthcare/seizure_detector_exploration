...
from hrvanalysis import get_time_domain_features, get_csi_cvi_features, get_sampen, get_poincare_plot_features, get_frequency_domain_features
...
def get_clean_intervals(rrs):
    ...
    median_interpolated_nn_intervals = signal.medfilt(interpolated_nn_intervals, 5)
